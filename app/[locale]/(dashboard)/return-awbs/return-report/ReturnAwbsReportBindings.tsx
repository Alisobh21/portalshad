...
interface ReturnAwbsReportBindingsProps {
  customHeight?: string;
}

/* ================= Component ================= */

export default function ReturnAwbsReportBindings({
  customHeight,
}: ReturnAwbsReportBindingsProps) {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-5">
        <div className="p-5 rounded-xl bg-neutral-200/20 dark:bg-neutral-700/20 lg:col-span-5 hidden xl:block">
          <ChartContainer
            config={chartConfig}
            className={cn(
