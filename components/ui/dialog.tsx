...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // Subtle blur and dimming when dialog is open.
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-neutral-500/70 dark:bg-neutral-900/70 backdrop-blur-[15px]",
        className
      )}
      {...props}
    />
