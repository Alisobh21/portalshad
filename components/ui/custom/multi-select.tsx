...
const controlStyles = {
  base: "border border-border rounded-lgcursor-pointer rounded-md px-2",
  focus: "",
  nonFocus: "border-border",
};
const placeholderStyles = "text-muted-foreground text-sm ms-1";
const selectInputStyles = "text-foreground text-sm ms-1";
const valueContainerStyles = "text-foreground text-sm";
const singleValueStyles = "ms-1";
const multiValueStyles =
  "ms-1 bg-background border border-border rounded items-center py-0.5 ps-2 pe-1 gap-1.5";
...
const dropdownIndicatorStyles = "text-muted-foreground/60 font-[300]";
const menuStyles =
...
const groupHeadingStyles = "ms-3 mt-2 mb-1 text-gray-500 text-sm bg-background";
