...
function Table({ className, ...props }: React.ComponentProps<"table">) {
    ...
    return (
        <div data-slot="table-container" className="relative w-full overflow-x-auto" dir={locale === "ar" ? "rtl" : "ltr"}>
            <table data-slot="table" dir={locale === "ar" ? "rtl" : "ltr"} className={cn("w-full caption-bottom text-sm", className)} {...props} />
        </div>
    );
}
